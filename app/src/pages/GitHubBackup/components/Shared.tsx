...
function CopyButton({ text }: { text: string }) {
  ...
  return (
    <button
      onClick={handleCopy}
      className="absolute right-2 top-1/2 -translate-y-1/2 p-1 rounded hover:bg-[var(--shell-surface-muted)] dark:hover:bg-gray-700 transition-colors"
      title={copied ? t('githubBackup.shared.copied') : t('githubBackup.shared.copy')}
    >
      <Icon name={copied ? 'check' : 'content_copy'} className="text-base text-[var(--text-secondary)] dark:text-gray-400" />
    </button>
  );
}
  ...
  return (
    ...
    >
      ...
      <h3 className="text-sm font-bold text-slate-900 dark:text-white mb-4 flex items-center gap-2">
        <Icon name="terminal" className="text-base text-[var(--accent-primary)]" />
      ...
      <Steps>
        <Step title={t('githubBackup.shared.step1Title')}>
          ...
          <div className="relative">
            <code className="block bg-[var(--shell-surface-soft)] dark:bg-gray-800 rounded-lg px-4 py-2 pr-9 text-sm font-mono text-[var(--accent-primary)]">/plugin marketplace add {marketplacePath}</code>
        ...
        <Step title={t('githubBackup.shared.step2Title')}>
          ...
          <div className="relative">
            <code className="block bg-[var(--shell-surface-soft)] dark:bg-gray-800 rounded-lg px-4 py-2 pr-9 text-sm font-mono text-[var(--accent-primary)]">/plugin install {'<skill-name>'}@{marketplacePath}</code>
      ...
      <div className="flex gap-4 py-4">
        <div className="flex-shrink-0 w-8 h-8 rounded-full bg-[var(--accent-primary)] text-white flex items-center justify-center font-bold text-sm">1</div>
      ...
      <div className="flex gap-4 py-4">
        <div className="flex-shrink-0 w-8 h-8 rounded-full bg-[var(--accent-primary)] text-white flex items-center justify-center font-bold text-sm">2</div>
        <div className="flex-1">
          ...
          <div className="relative">
            <code className="block bg-[var(--shell-surface-soft)] dark:bg-gray-800 rounded-lg px-4 py-2 pr-9 text-sm font-mono text-[var(--accent-primary)] break-all">https://github.com/{marketplacePath}</code>
