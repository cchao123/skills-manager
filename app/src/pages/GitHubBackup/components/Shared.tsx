    ...
    <Collapse
      ...
      title={
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-xl font-bold text-slate-900 dark:text-white">共享他人安装</h2>
        </div>
      }
    >
      ...
      <h3 className="text-sm font-bold text-slate-900 dark:text-white mb-4 flex items-center gap-2">
        ...
        Claude Code
        <span className="text-xs font-normal text-slate-400 dark:text-gray-500">via Plugin Marketplace</span>
      </h3>
      ...
      <div className="flex gap-4 py-4">
        ...
        <div className="flex-1">
          <h3 className="font-bold text-slate-900 dark:text-white mb-1">注册 Marketplace</h3>
          <p className="text-sm text-slate-600 dark:text-gray-300 mb-2">在 Claude Code 中运行以下命令注册 marketplace：</p>
      ...
      <div className="flex gap-4">
        ...
        <div className="flex-1">
          <h3 className="font-bold text-slate-900 dark:text-white mb-1">安装插件</h3>
          <p className="text-sm text-slate-600 dark:text-gray-300 mb-2">从 marketplace 安装插件：</p>
          <div className="relative">
